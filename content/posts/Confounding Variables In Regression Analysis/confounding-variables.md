...
this is called mediation and $X_2$ in this case is a mediator. And we're saying that confounding can occur when $X_1$ directly effects $X_2$ WHICH THEN effects the outcome $y$. 
